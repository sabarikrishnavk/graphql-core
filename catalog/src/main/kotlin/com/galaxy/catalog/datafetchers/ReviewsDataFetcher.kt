...
//
//import com.galaxy.catalog.dataloaders.ReviewsDataLoader
...
//import com.galaxy.catalog.services.ReviewsService
...
//     */
//    @DgsData(parentType =  DgsConstants.SKU.TYPE_NAME, field = com.galaxy.catalog.generated.DgsConstants.SHOW.Reviews)
//    fun reviews(dfe: DgsDataFetchingEnvironment): CompletableFuture<List<com.galaxy.catalog.generated.types.Review>> {
//        //Instead of loading a DataLoader by name, we can use the DgsDataFetchingEnvironment and pass in the DataLoader classname.
//        val reviewsDataLoader: DataLoader<Int, List<com.galaxy.catalog.generated.types.Review>> = dfe.getDataLoader(ReviewsDataLoader::class.java)
//
//        //Because the reviews field is on Show, the getSource() method will return the Show instance.
//        val show : com.galaxy.catalog.generated.types.Show = dfe.getSource()
//
...
//
//    @DgsMutation
//    fun addReview(@InputArgument review: com.galaxy.catalog.generated.types.SubmittedReview): List<com.galaxy.catalog.generated.types.Review> {
...
//
//    @DgsSubscription
//    fun reviewAdded(@InputArgument showId: Int): Publisher<com.galaxy.catalog.generated.types.Review> {
